                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="faq-service feature-section-text mt_50">
                            <h2>{{ $websiteLang->where('lang_key','faqs')->first()->custom_lang }}</h2>
...
{{--                            <h3>{{ $websiteLang->where('lang_key','related_video')->first()->custom_lang }}</h3>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                </div>--}}
                    ...
                    <form action="{{ url('contact-message') }}" method="POST">
                        ...
                        <div class="form-row row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="datetime-local" class="form-control" placeholder="hello bro" name="timeForContact">
                            </div>
            ...
            <div class="col-md-4">
                <div class="service-sidebar pt_30">
                    <h1 class="text-center">Other Services</h1>
