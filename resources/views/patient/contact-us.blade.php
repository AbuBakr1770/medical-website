    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                <h3>Send us an inquiry and we will get back to when you want!</h3>
            </div>
            <div class="col-md-7">
                ...
                <form action="{{ url('contact-message') }}" method="POST">
                    ...
                    <div class="row contact-form">
                        <div class="col-lg-6 form-group">
                            <label>{{ $websiteLang->where('lang_key','name')->first()->custom_lang }} *</label>
                            <input type="text" class="form-control" id="name"  name="name">
                        </div>
                        <div class="col-lg-6 form-group">
                            <label>{{ $websiteLang->where('lang_key','email')->first()->custom_lang }} *</label>
                            <input type="email" id="email" class="form-control"  name="email">
                        </div>
                        <div class="col-lg-6 form-group">
                            <label>{{ $websiteLang->where('lang_key','phone')->first()->custom_lang }} *</label>
                            <input type="tel"  placeholder="xx-123-4567890" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" class="form-control">
                        </div>

                        <div class="col-lg-6 form-group">
                            <label>Patient's Gender (Optional)</label>
                        ...
                        <div class="col-lg-6 form-group">
                            <label>{{ $websiteLang->where('lang_key','subject')->first()->custom_lang }} *</label>
                            <input type="text" id="subject" class="form-control" name="subject">
                        </div>
                        <div class="col-lg-6 form-group">
                            <label>{{ $websiteLang->where('lang_key','country')->first()->custom_lang }} *</label>
                            <input type="text" id="subject" class="form-control" name="subject">
                        </div>
                        <div class="col-lg-12 form-group">
                            <label>Best time to to contact you *</label>
                            <input type="datetime-local" id="subject" class="form-control" name="subject">
                            <small>Click the calender icon at right</small>
                        </div>


                        <div class="col-lg-12 form-group">
                            <label>{{ $websiteLang->where('lang_key','msg')->first()->custom_lang }} *</label>
            ...
            <div class="col-md-5">
                <div class="contact-info-item bg1 mb_30 mt_30">
                    <div class="contact-info">
                        <span>
                            <i class="fas fa-phone"></i> {{ $websiteLang->where('lang_key','phone')->first()->custom_lang }}:
                        </span>
                ...
                <div class="contact-info-item bg2 mb_30">
                    <div class="contact-info">
                        <span>
                            <i class="far fa-envelope"></i> {{ $websiteLang->where('lang_key','email_address')->first()->custom_lang }}:
                        </span>
                        <div class="contact-text">
                ...
                <div class="contact-info-item bg3 mb_30">
                    <div class="contact-info">
                        <span>
                            <i class="fas fa-map-marker-alt"></i> {{ $websiteLang->where('lang_key','address')->first()->custom_lang }}:
                        </span>
                        <div class="contact-text">
                            <p>
