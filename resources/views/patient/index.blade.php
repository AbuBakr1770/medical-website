                ...
                <div class="team-carousel owl-carousel">
                    ...
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            ...
                            <p><span><b><i class="fas fa-street-view"></i> Hospital Name</b></span></p>
...
<div class="team-area">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="main-headline">
                    <h1><span>{{ ucfirst($doctor_section->first_header) }}</span> Hospitals </h1>
                    <p>{{ $doctor_section->description }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="team-carousel owl-carousel">
                    ...
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            ...
                            <p><span><i class="fas fa-graduation-cap"></i> {{ $doctor->designations }}</span></p>
                            <p><span><b><i class="fas fa-street-view"></i> {{ ucfirst($doctor->location->location) }}</b></span></p>
                            <p><span><b><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i> </b></span></p>
