                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('doctor.store-zoom-credential') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="zoom_api_key">{{ $websiteLang->where('lang_key','zoom_api_key')->first()->custom_lang }}</label>
                        ...
                        <div class="form-group">
                            <label for="zoom_api_secret">{{ $websiteLang->where('lang_key','zoom_api_secret')->first()->custom_lang }}</label>
