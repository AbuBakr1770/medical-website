            ...
            <div class="row">
                <div class="col-md-3 col-6">
                    <div class="logo-logo flex">
                        <a href="{{ url('/') }}"><img src="{{ asset($logo->logo) }}"  style="height: 80px;" alt="Logo"></a>
{{--                        <a href="{{ url('/') }}"><img src="../../../../assets/logo.png" alt="Logo"></a>--}}
                ...
                <div class="col-md-9 col-6">
                    <div class="main-menu">
                        <ul class="nav-menu">
                           ...
                           <li class="special-button"><a class="navbar-contact-btn" href="{{ url('contact-us') }}">{{ $navigation->contact_us }}</a></li>
                            @endif
...
{{--                        @endif--}}
                    <li class="special-button"><a href="{{ url('contact-us') }}">Contact us</a></li>

{{--                    <li class="special-button"><a href="{{ url('contact-us') }}" data-toggle="modal" data-target="#appointment_modal1">{{ $navigation->appointment }}</a></li>--}}
                 <!-- Modal -->
